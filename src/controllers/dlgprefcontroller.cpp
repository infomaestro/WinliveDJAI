...
DlgPrefController::DlgPrefController(
    ...
    m_ui.labelWarning->setText(tr(
            ...
            "This mapping was designed for a newer Winlive Dj Ai Controller Engine "
            "and cannot be used on your current Winlive Dj Ai installation.<br>"
            "Your Winlive Dj Ai installation has Controller Engine version %1. "
